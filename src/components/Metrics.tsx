        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="text-center lg:text-left">
            ...
            <p className="text-lg text-gray500 mb-8 leading-relaxed">
              Современные технологии открывают новые возможности для юридической практики и взаимодействия с клиентами. Пора использовать инновации для развития бизнеса.
            </p>
